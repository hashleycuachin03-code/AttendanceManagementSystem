...
public class login_admin_employee extends javax.swing.JFrame {
    ...
    private boolean credentialsMatch(Connection connection, String sql, String username, String password) throws SQLException {
    ...
    private void login() {
        ...
        try (Connection connection = DatabaseConnection.open()) {
            ...
            JOptionPane.showMessageDialog(this, "Could not sign in. " + error.getMessage(), "Database error", JOptionPane.ERROR_MESSAGE);
        }
    }
